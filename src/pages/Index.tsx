...
{isAnniversary(day) && !isBirthday(day) && (
          ...
          <div className="glass rounded-2xl overflow-hidden animate-fade-in">
            <div className="p-2 border-b border-border bg-muted/50 rounded-md"><StepsCard leadingSpacer /></div>
          ...
          return (
            ...
            >
              ...
              <div style={{
                position: "absolute",
                inset: 0,
                backgroundColor: "rgba(180, 20, 40, 0.03)",
              }} />
            </div>
          );
        })}
                        ...
                        return (
                          <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                            ...
                            {customRewards.map((r) => (
                              <span
                                key={r.id}
                                className="inline-flex items-center gap-1 text-[10px] px-1.5 py-0 h-4 rounded border-warning/35 whitespace-nowrap shrink-0 shadow-none border bg-[#ffcf9e] text-orange-800"
                  ...
                  {hourlyTasks.length > 0 && (
                    <div className="space-y-1.5">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Progresivní ({hourlyTasks.length})</span>
                      </div>
